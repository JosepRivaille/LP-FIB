...
#endif
{
  ...
  queries(zzSTR); zzlink(_root, &_sibling, &_tail);
...
#endif
{
  ...
  {
  {
    ...
    {
    while ( (LA(1)==START) ) {
      role(zzSTR); zzlink(_root, &_sibling, &_tail);
      zzLOOP(zztasp2);
    }
    zzEXIT(zztasp2);
    }
...
#endif
{
  ...
  processP0(zzSTR); zzlink(_root, &_sibling, &_tail);
...
#endif
{
  ...
  zzMake0;
  {
  zzmatch(FILEP); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
  filep(zzSTR); zzlink(_root, &_sibling, &_tail);
  zzEXIT(zztasp1);
  return;
fail:
  zzEXIT(zztasp1);
...
#endif
{
  ...
  zzMake0;
  {
  zzmatch(FILEDIR); zzsubroot(_root, &_sibling, &_tail); zzCONSUME;
  zzmatch(ID); zzsubchild(_root, &_sibling, &_tail); zzCONSUME;
  zzmatch(ID); zzsubchild(_root, &_sibling, &_tail); zzCONSUME;
  zzEXIT(zztasp1);
  return;
...
#endif
{
  ...
  {
  {
    ...
    for (;;) {
      ...
      if ( (LA(1)==CRITICAL) ) {
        critical(zzSTR); zzlink(_root, &_sibling, &_tail);
      }
      else {
        if ( (LA(1)==DIFFERENCE) ) {
          difference(zzSTR); zzlink(_root, &_sibling, &_tail);
        }
        else {
          if ( (LA(1)==CORRECTFILE) ) {
            correctfile(zzSTR); zzlink(_root, &_sibling, &_tail);
          }
...
#endif
{
  ...
  zzMake0;
  {
  processP1(zzSTR); zzlink(_root, &_sibling, &_tail);
  {
    zzBLOCK(zztasp2);
    zzMake0;
    {
...
#endif
{
  ...
  zzMake0;
  {
  processP2(zzSTR); zzlink(_root, &_sibling, &_tail);
  {
    zzBLOCK(zztasp2);
    zzMake0;
    {
...
#endif
{
  ...
  zzMake0;
  {
  processP3(zzSTR); zzlink(_root, &_sibling, &_tail);
  {
    zzBLOCK(zztasp2);
    zzMake0;
    {
...
#endif
{
  ...
  zzMake0;
  {
  processP4(zzSTR); zzlink(_root, &_sibling, &_tail);
  {
    zzBLOCK(zztasp2);
    zzMake0;
    {
